...
<%@ page import="com.oreilly.servlet.multipart.DefaultFileRenamePolicy" %> <!-- 같은파일 덮어써져서 충돌방지 시킴 새폴더(1) 새폴더(2) --> 
...
<%
	...
	try{
		...
		String name = files.nextElement().toString(); // /1개의 파일
		
		// 파일 이름 충돌이 발생할 시를 대비하여 2개의 메소드를 모두 사용

...
namespace BookManager
{
    public partial class Form1 : Form
    {
        // 변수 타입
        // 메소드 저장하는 변수
        // 반환형은 bool 매개변수 Book을 갖는 메소드를 저장
        ...
        void refreshScreen()
        {
            ...
            //};
            // where : 매개변수로 메소드를 받음
            // 매개변수가 Book타입 변수 1개이고 반환형이 bool 형태인
            // 메소드를 람다나 델리게이트나 메소드 이름이나 이런 형태로 집어넣음
            ...
            // 델리게이트형태
            label4.Text = "연체중인 도서 수";
            DataManager.books.Where(delegate (Book b)
            {
        ...
        public Form1()
        {
            ...
            void borrowBook(object s, EventArgs e)
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("없는 책 or ID 입니다.");
                ...
                else
                {
                    try
                    {
                        ...
                        if( b.isBorrowed)
                        {
                            ...
                            b.isBorrowed = false;
                            DateTime oldday = b.BorrowedAt; // 빌렷던 날짜 저장
